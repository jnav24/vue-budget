<script src="./common-expense.ts" lang="ts"></script>
<style src="./common-expense.scss" lang="scss" scoped></style>

<template>
	<div id="common-expense" :class="`budget-template ${getExpenseType()}`">
			...
			<v-layout>
				<v-flex lg5 xl5>
					<v-select
						...
						item-value="id"
						item-text="name"
						:label="`${getExpenseType()} Types`"></v-select>
				</v-flex>
